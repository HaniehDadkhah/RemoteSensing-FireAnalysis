"// Google Earth Engine Script for Fire Severity Analysis" 
//                                     SET TIME FRAME
var prefire_start = '2017-05-01';   
var prefire_end = '2017-06-01';
var postfire_start = '2017-09-10';
var postfire_end = '2017-09-30';
var platform = 'S2';        
...
var dNBR_clip = dNBR.clip(geometry2);
Map.addLayer(dNBR_clip.sldStyle(sld_intervals), {}, 'dNBR_2017');
//                              ADD BURNED AREA STATISTICS

// count number of pixels in entire layer
var allpix =  dNBR_clip.updateMask(dNBR_clip);  // mask the entire layer
